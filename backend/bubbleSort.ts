...
//Para resolver la consigna que pedia que los ordene en forma descendente, lo que hice fue cambiar el signo en la linea 49.
//En el codigo de Karen habia un "=" entonces lo que hice fue poner "<"